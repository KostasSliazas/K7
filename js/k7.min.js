((n,g)=>{const l=g.documentElement,f=(a,...c)=>{for(let b=0;b<c.length;b++)a.appendChild(c[b])},d=(a,...c)=>{a=g.createElement(a);for(let b=0;b<c.length;b+=2)a.setAttribute(c[b],c[b+1]);return a};class p{constructor(){this.delay=1510;this.h=[];this.g=null;this.isActive=this.l=!1;this.m=0}N(){const a=0<g.getElementsByClassName("images").length?g.getElementsByClassName("images"):g.getElementsByTagName("body"),c=a.length;for(var b=0;b<c;b++){var e=a[b].getElementsByTagName("img");for(let k=0;k<e.length;k++){const h=
e[k];h.src?this.h.push(h):console.warn('Missing "src" attribute:',h)}}b=k=>this.V(k);if(a[0]&&"BODY"===a[0].tagName)g.body.onclick=b;else for(e=0;e<c;e++)a[e].onclick=b;return this.h.length}I(){this.l||(this.l=!0,this.C.className="but bra brb opa tpo lft atc");this.l&&(clearTimeout(this.m),this.m=setTimeout(()=>{this.G().show();this.g===this.h.length-1&&this.F()},this.delay))}P(){const a=d("a","rel","noopener","download",this.i.src.split("/").pop(),"href",this.i.src,"target","_blank");a.click();a.remove()}U(){this.g=
0<this.g?this.g-1:this.h.length-1;return this}G(){this.g=this.g<this.h.length-1?this.g+1:0;return this}F(){this.m&&(clearTimeout(this.m),this.m=null);this.l=!1;this.s.className=this.u.className="";this.C.className="but bra brb opa tpo lft";this.K.className="but bra brb opa rtm rtp";this.L()}L(){this.B.className=0===this.g?"dpn":"but tpo hvr lft";this.v.className=this.g===this.h.length-1?"dpn":"but tpo hvr rgt"}close(){this.isActive=!1;this.j.className="sca hdi w10 tpo lft";l.className=l.className.split("fff").join("").trim()}show(){const a=
this.h[this.g],c=a.src;var b=c.split("/").pop();const e=b.split("."),k=e[0]+"."+(a.dataset.ext||"jpg");b="svg"===e?c:c.replace(b,"large/"+k);this.isActive||(this.isActive=!0,l.className=l.className?l.className+" fff":"fff",this.j.className="fff w10 tpo lft");this.i.src!==b&&this.i.src!==c&&(this.A.className="bor",this.o.removeChild(this.i),this.i=d("img","src","svg"==e[1]?c:b,"alt",a.alt+" selected"),this.i.onload=h=>{this.A.className="dpn";this.H.innerText=h.target.src.split("/").pop();this.l&&this.I()},
