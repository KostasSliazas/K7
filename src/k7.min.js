...
this.h[this.g],c=a.src;var b=c.split("/").pop();const e=b.split("."),l=e[0]+"."+e[1];b="svg"===e?c:c.replace(b,"l/"+l);this.isActive||(this.isActive=!0,k.className=k.className?k.className+" fff":"fff",this.j.className="fff w10 tpo lft");this.i.src!==b&&this.i.src!==c&&(this.A.className="bor",this.o.removeChild(this.i),this.i=d("img","src","svg"==e[1]?c:b,"alt",a.alt+" selected"),this.i.onload=h=>{this.A.className="dpn";this.H.innerText=h.target.src.split("/").pop();this.l&&this.I()},this.i.onerror=
