...
this.h[this.g],c=a.src;var b=c.split("/").pop();const e=b.split("."),h=e[0]+"."+(a.dataset.ext||"jpg");b="svg"===e?c:c.replace(b,"large/"+h);this.isActive||(this.isActive=!0,k.className=k.className?k.className+" fff":"fff",this.j.className="fff w10 tpo lft");this.i.src!==b&&this.i.src!==c&&(this.A.className="bor",this.o.removeChild(this.i),this.i=d("img","src","svg"==e[1]?c:b,"alt",a.alt+" selected"),this.i.onload=l=>{this.A.className="dpn";this.H.innerText=l.target.src.split("/").pop();this.l&&this.I()},
this.i.onerror=l=>{l.target.onerror=null;l.target.src=c},this.D&&(this.D.innerText=Number(this.g)+1),f(this.o,this.i),this.L())}V(a){const c=a.target;"IMG"===c.tagName&&(this.g=-1<this.h.indexOf(c)?this.h.indexOf(c):0,this.show(),a.stopImmediatePropagation())}W(){const a={pli:()=>{this.I()},blt:()=>{this.U().show()},btr:()=>{this.G().show()},cls:()=>{this.close()},dlf:()=>{this.P()}};a[" "]=a.pli;a.ArrowLeft=a.blt;a.ArrowRight=a.btr;const c=b=>{if(this.isActive){b.preventDefault();b.stopImmediatePropagation();
